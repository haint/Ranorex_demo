...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The CloseTelemetry recording.
    /// </summary>
    [TestModule("409cd734-66da-411a-8e2b-ed8c1eae03cf", ModuleType.Recording, 1)]
    public partial class CloseTelemetry : ITestModule
    {
        /// <summary>
        ...
        static CloseTelemetry instance = new CloseTelemetry();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public CloseTelemetry()
        {
        }
        ...
        /// </summary>
        public static CloseTelemetry Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key 'Ctrl+W' Press.", new RecordItemIndex(0));
