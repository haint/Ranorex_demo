...
{
	public partial class UninstallCP
	{
		/// <summary>
		...
		public void checkDHSIconOnDesktop()
		{
			...
			{
				Report.Log(ReportLevel.Failure, "DHS Icon found on Desktop. Uninstall fail!");
			}else{
				Report.Log(ReportLevel.Success, "DHS Icon not found on Desktop. Uninstall success!S");
			}
		}
		...
		public void checkDHSIconOnAllApps()
		{
			...
			try{
				...
				Report.Log(ReportLevel.Failure, "DHS Icon found on All App Start Menu. Uninstall fail!");
			}
			catch(RanorexException ex){
				Report.Log(ReportLevel.Success, "DHS Icon NOT found on All App Start Menu. Uninstall success!");
			}
		...
		public void checkDHSIconOnStartMenu()
		{
			...
			try{
				...
				if(isConfirmManualSteps.Equals("True")){
					...
					WinForms.DialogResult result =  WinForms.MessageBox.Show(msg, "Confirm Step",
		...
		public void checkFolderExits(string path, string action)
		{
			...
			for(int i=0; i< dir.Length; i++){
				...
				if(i==0){
					...
					fileExplorerXpath = "/form[@processname='explorer' and @title='" + "Local Disk (" + dir[i] + ")']";
				}
				else{
					// find file explorer
